...
class DefaultApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.notices_v1_un_get_endpoint = _Endpoint(
            settings={
                "response_type": (UNNotices,),
                "auth": [],
                "endpoint_path": "/notices/v1/un",
                "operation_id": "notices_v1_un_get",
                "http_method": "GET",
                "servers": None,
            },
            params_map={
        ...
        self.notices_v1_un_notice_type_notice_id_get_endpoint = _Endpoint(
            settings={
                "response_type": (YellowNoticeDetail,),
                "auth": [],
                "endpoint_path": "/notices/v1/un/{noticeType}/{noticeID}",
                "operation_id": "notices_v1_un_notice_type_notice_id_get",
                "http_method": "GET",
                "servers": None,
            },
            params_map={
        ...
        self.notices_v1_un_notice_type_notice_id_images_get_endpoint = _Endpoint(
            settings={
                "response_type": (UNNoticeDetailImages,),
                "auth": [],
                "endpoint_path": "/notices/v1/un/{noticeType}/{noticeID}/images",
                "operation_id": "notices_v1_un_notice_type_notice_id_images_get",
                "http_method": "GET",
                "servers": None,
            },
            params_map={
        ...
        self.notices_v1_yellow_get_endpoint = _Endpoint(
            settings={
                "response_type": (YellowNotices,),
                "auth": [],
                "endpoint_path": "/notices/v1/yellow",
                "operation_id": "notices_v1_yellow_get",
                "http_method": "GET",
                "servers": None,
            },
            params_map={
        ...
        self.notices_v1_yellow_notice_id_get_endpoint = _Endpoint(
            settings={
                "response_type": (YellowNoticeDetail,),
                "auth": [],
                "endpoint_path": "/notices/v1/yellow/{noticeID}",
                "operation_id": "notices_v1_yellow_notice_id_get",
                "http_method": "GET",
                "servers": None,
            },
            params_map={
        ...
        self.notices_v1_yellow_notice_id_images_get_endpoint = _Endpoint(
            settings={
                "response_type": (YellowNoticeDetailImages,),
                "auth": [],
                "endpoint_path": "/notices/v1/yellow/{noticeID}/images",
                "operation_id": "notices_v1_yellow_notice_id_images_get",
                "http_method": "GET",
                "servers": None,
            },
            params_map={
    ...
    def notices_v1_un_get(self, **kwargs):
        """Get UN Notices  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.notices_v1_un_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_content_type"] = kwargs.get("_content_type")
        kwargs["_host_index"] = kwargs.get("_host_index")
        return self.notices_v1_un_get_endpoint.call_with_http_info(**kwargs)

    def notices_v1_un_notice_type_notice_id_get(self, notice_id, notice_type, **kwargs):
        """Get UN Notice Details  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.notices_v1_un_notice_type_notice_id_get(notice_id, notice_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_host_index"] = kwargs.get("_host_index")
        kwargs["notice_id"] = notice_id
        kwargs["notice_type"] = notice_type
        return (
            self.notices_v1_un_notice_type_notice_id_get_endpoint.call_with_http_info(
                **kwargs
            )
        )

    def notices_v1_un_notice_type_notice_id_images_get(
        self, notice_id, notice_type, **kwargs
    ):
        ...
        >>> thread = api.notices_v1_un_notice_type_notice_id_images_get(notice_id, notice_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["notice_id"] = notice_id
        kwargs["notice_type"] = notice_type
        return self.notices_v1_un_notice_type_notice_id_images_get_endpoint.call_with_http_info(
            **kwargs
        )

    def notices_v1_yellow_get(self, **kwargs):
        """Get Yellow Notices  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.notices_v1_yellow_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_content_type"] = kwargs.get("_content_type")
        kwargs["_host_index"] = kwargs.get("_host_index")
        return self.notices_v1_yellow_get_endpoint.call_with_http_info(**kwargs)

    def notices_v1_yellow_notice_id_get(self, notice_id, **kwargs):
        """Get Yellow Notice Details  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.notices_v1_yellow_notice_id_get(notice_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_host_index"] = kwargs.get("_host_index")
        kwargs["notice_id"] = notice_id
        return self.notices_v1_yellow_notice_id_get_endpoint.call_with_http_info(
            **kwargs
        )

    def notices_v1_yellow_notice_id_images_get(self, notice_id, **kwargs):
        """Get Yellow Notice Images  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.notices_v1_yellow_notice_id_images_get(notice_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_host_index"] = kwargs.get("_host_index")
        kwargs["notice_id"] = notice_id
        return self.notices_v1_yellow_notice_id_images_get_endpoint.call_with_http_info(
            **kwargs
        )
